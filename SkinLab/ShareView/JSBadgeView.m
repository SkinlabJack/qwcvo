...
#define kDefaultBadgeTextColor [UIColor grayColor]
#define kDefaultBadgeBackgroundColor [UIColor whiteColor]
...
#define kBadgeStrokeColor [UIColor colorWithRed:255/255.0 green:234/255.0 blue:27/255.0 alpha:1]
//#define kBadgeStrokeColor [UIColor colorWithWhite:1 alpha:0.5]
...
{    
    ...
    CGFloat viewWidth = textWidth + kBadgeTextSideMargin + (kMarginToDrawInside * 2) + 13;
    ...
    switch (self.badgeAlignment) {
        ...
        case JSBadgeViewAlignmentTopRight:
            newFrame.origin.x = superviewWidth - viewWidth + 7;
            newFrame.origin.y = -2;//-viewHeight / 2.0f;
            break;
        ...
        case JSBadgeViewAlignmentCenter:
            ...
            newFrame.origin.y = (superviewHeight - viewHeight) / 2.0f;
            break;
        case JSBadgeViewAlignmentCell:
            newFrame.origin.x = 32;
            newFrame.origin.y = -5;
            break;
        case JSBadgeViewAlignmentSegment:
            newFrame.origin.x = 75 - 20;
            newFrame.origin.y = -2;
            break;
        case JSBadgeViewAlignmentTabbar:
            newFrame.origin.x = 60 - 20;
            newFrame.origin.y = -2;
            break;
        default:
...
{
    rect.size.width = [self.badgeText sizeWithFont:self.badgeTextFont].width + 15;
